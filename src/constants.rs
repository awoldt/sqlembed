...
pub const TEXT_EXTENSIONS: &[&str] = &[
    ...
    "html", "htm", "svg", "sql", "log", "rs", "go", "py", "java", "kt", "scala", "cs", "c", "h",
    "cpp", "hpp", "swift", "dart", "zig", "lua", "rb", "php", "pl", "r", "jl", "hs", "js", "jsx",
    "mjs", "cjs", "ts", "tsx", "css", "scss", "sass", "less", "sh", "bash", "zsh", "fish", "ps1",
    "bat", "cmd", "mk", "cmake", "tf", "tfvars", "hcl", "proto", "graphql", "gql", "tex", "bib",
